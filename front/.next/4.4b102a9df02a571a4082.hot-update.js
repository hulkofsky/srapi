...
function (_React$Component) {
  ...
  _createClass(HomePage, [{
    ...
    value: function componentDidMount() {
      ...
      window.addEventListener('scroll', throttle(this.handleJustLivingScroll.bind(this), 1));
    ...
    value: function handleJustLivingScroll(e) {
      ...
      if (deltaY > 0) {
        if (!justLivingSlidingBlock.classList.contains('fully-scrolled')) {
          window.scrollTo(0, window.scrollY - deltaY); // document.body.style.overflow = "hidden";
        }
...
(function () {
  ...
  reactHotLoader.register(throttle, "throttle", "C:\\Users\\venom\\Desktop\\future_generation\\front\\pages\\index.jsx");
...
//# sourceMappingURL=4.4b102a9df02a571a4082.hot-update.js.map