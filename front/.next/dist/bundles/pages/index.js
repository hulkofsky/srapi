...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__index_scss__ = __webpack_require__("./pages/index.scss");
...
function (_React$Component) {
  ...
  function HomePage() {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "horizontalScroll", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createRef()
    }), Object.defineProperty(_assertThisInitialized(_this), "horizontalScrollOuter", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createRef()
  ...
  _createClass(HomePage, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.registerHorizontalScrollListener(); // let justLivingSlidingBlock = document.querySelector(".sliding-block")
    ...
    key: "registerHorizontalScrollListener",
    value: function registerHorizontalScrollListener() {
      var _this2 = this;

      var WIDTH_OF_CONTAINER = window.innerWidth;
      var HEIGHT_OF_CONTAINER = WIDTH_OF_CONTAINER * 2;
      this.horizontalScrollOuter.current.style.height = "".concat(HEIGHT_OF_CONTAINER, "px");
      window.addEventListener('scroll', function (e) {
        var distanceFromTop = parseInt(_this2.horizontalScrollOuter.current.getBoundingClientRect().top);
        var containerHeight = parseInt(_this2.horizontalScrollOuter.current.clientHeight);
        var scrollPosition = parseInt(window.pageYOffset);

        if (distanceFromTop < 0 && distanceFromTop > -WIDTH_OF_CONTAINER) {
          // If the horizontal container is above the top of the page
          var leftOffset = easeInOutCubic(-distanceFromTop / WIDTH_OF_CONTAINER) * WIDTH_OF_CONTAINER;
          _this2.horizontalScroll.current.style.left = "-".concat(leftOffset, "px");
          _this2.horizontalScroll.current.style.marginLeft = "auto";
          _this2.horizontalScroll.current.style.marginTop = "auto";
          _this2.horizontalScroll.current.style.position = 'fixed';
        } else if (distanceFromTop >= 0) {
          //
          _this2.horizontalScroll.current.style.position = 'relative';
          _this2.horizontalScroll.current.style.marginLeft = "auto";
          _this2.horizontalScroll.current.style.marginTop = "auto";
        } else {
          _this2.horizontalScroll.current.style.position = 'relative';
          _this2.horizontalScroll.current.style.marginTop = "".concat(WIDTH_OF_CONTAINER, "px");
        }
      });
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      window.removeEventListener('scroll', this.updateRoomTypesImagesClasses); // window.removeEventListener('scroll', this.handleJustLivingScroll)
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        ...
        ref: this.horizontalScrollOuter,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 358
        }
