...
function (_React$Component) {
  ...
  _createClass(LocationsList, [{
    ...
    value: function render() {
      ...
      }, "featuring the UKs first LED cinema on site")))), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(Link, {
        href: {
          pathname: '/location',
          query: {
            id: 1
...
function (_React$Component) {
  ...
  _createClass(HomePage, [{
    ...
    value: function render() {
      ...
      }, "TO MAKE YOUR LEAP")), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10__components_LocationsList__["a" /* default */], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 427
        }
...
//# sourceMappingURL=4.6e5e09f82f10bdbbcc29.hot-update.js.map