...
var _default = function _default(scene) {
  ...
  cubeGroup.rotation.set(36 * deg, 225.1 * deg, 0); //======ANIMATIONS=====//

  var cubeAnimation = new __WEBPACK_IMPORTED_MODULE_1_gsap__["a" /* TimelineMax */]();
  cubeAnimation.from(SceneSubject.pivot.rotation, 1, {
    z: 40 * deg,
    x: -10 * deg
  }).pause();
  cubeAnimation.from(SceneSubject.cubeGroup.rotation, 1, {
    y: 245 * deg
  }, '-=1').pause();
  cubeAnimation.from(SceneSubject.cubeGroup.position, 1, {
    y: 0.5,
    z: -5
  }, '-=1').pause(); //======ANIMATIONS=====//
  //===== GLOBAL ==== ///
...
//# sourceMappingURL=4.ab378b19b1015368b2d5.hot-update.js.map