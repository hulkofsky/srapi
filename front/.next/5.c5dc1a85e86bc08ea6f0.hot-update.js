  ...
  _createClass(LocationPage, [{
    ...
    value: function setupItemsSliders() {
      ...
      sliders.map(function (slider) {
        var controls = Array.prototype.slice.call(slider.getElementsByClassName("slider-controls"));
        console.log(slider.getElementsByClassName("slider-controls"));
        controls.map(function (control, index) {
          control.addEventListener("click", _this2.setActiveSlide(slider, index));
...
//# sourceMappingURL=5.c5dc1a85e86bc08ea6f0.hot-update.js.map