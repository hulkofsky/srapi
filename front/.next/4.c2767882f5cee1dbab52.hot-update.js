    ...
    value: function handleJustLivingScroll(e) {
      ...
      if (deltaY > 0) {
        if (!justLivingSlidingBlock.classList.contains('fully-scrolled')) {
          ...
          justLivingSlidingBlock.style.overflow = "hidden";
        }
        ...
        if (justLivingSlidingBlock.classList.contains('partially-scrolled') || justLivingSlidingBlock.classList.contains('fully-scrolled')) {// window.scrollTo(0, window.scrollY - deltaY)
        }
...
//# sourceMappingURL=4.c2767882f5cee1dbab52.hot-update.js.map