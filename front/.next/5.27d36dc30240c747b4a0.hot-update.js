...
function (_React$Component) {
  ...
  _createClass(HomePage, [{
    ...
    value: function componentDidMount() {
      ...
      justLivingSlidingBlock.addEventListener('touchend', function (e) {
        console.log('touchend');
      });
      justLivingSlidingBlock.addEventListener('touchmove', function (e) {
        var deltaY = e.changedTouches[0].clientY - _this2.state.justLivingSlidingBlockTouchLastY;
        console.log(deltaY);
      });
...
//# sourceMappingURL=5.27d36dc30240c747b4a0.hot-update.js.map