...
function (_React$Component) {
  ...
  _createClass(HomePage, [{
    ...
    value: function setActiveAdvantage(index) {
      var advantagesNames = document.querySelectorAll(".advantages-list .advantages-names");

      for (i = 0; i < advantagesNames.length; ++i) {
        if (i !== index) {
...
//# sourceMappingURL=4.0b9e56330344244e119b.hot-update.js.map